        ...
        <div className='p-5'>
            <div>
                ...
                <div className='flex justify-center p-20'>
                    <form className=' border p-5 bg-orange-200 rounded-xl  ' id='todoForm' onSubmit={(event) => addTodo(event)}>

                        <h1 className='text-2xl font-bold p-10'>Create Todo for the Day</h1>
                        <div className='flex flex-col justify-center px-10 py-3'>
                            ...
                            />
                            <br />
                            <button type='submit' className='rounded-lg p-1 px-3 m-4 mt-2 ml-10 bg-red-400'>Add TODO</button>
                        </div>
                    </form>
                </div>
